const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./maplibre-gl-B2k4QVOw.css","./toast-B4f45Ia7.js","./toast-BHUq2m9W.js","./sync-B1j4jR5F.js","./sync-Cb04crC8.js","./persona-qQZFQVKd.js","./secp256k1-D-yRSwrI.js","./hmac-B1-wU9bE.js","./connect-Bn5elW7I.js","./connect-D-R7kIB_.js","./profiles-T8ZRLsnR.js","./profiles-acz-6pTl.js","./nip19-DrgiY30G.js","./base-Ce7yIVNZ.js","./pure-Btd1YSCP.js","./liveness-CNUWJmZ3.js","./header-YV_12d5O.js","./nip44-C1QNfhAC.js","./bip39-E3q2Lx2v.js","./bip39-C27OIEeD.js","./english-CkWtSUmR.js","./english-CivtqfBt.js","./mnemonic-Bo8aQXHv.js","./mnemonic-Clp38q00.js"])))=>i.map(i=>d[i]);
import{a as e,d as t,f as n,i as r,m as i,n as a,o,p as s,r as c,s as l,u}from"./connect-D-R7kIB_.js";import{c as d,f,i as p,l as m,m as h,p as g,r as _,s as v,t as y,u as b}from"./nip19-DrgiY30G.js";import{C as ee,S as x,T as te,_ as ne,a as re,b as S,c as C,d as ie,g as ae,h as oe,i as se,l as ce,n as le,o as w,r as T,s as E,t as ue,u as de,v as fe,w as pe,x as me,y as he}from"./header-YV_12d5O.js";import{t as ge}from"./secp256k1-D-yRSwrI.js";import{i as D,r as _e,t as ve}from"./pure-Btd1YSCP.js";import{n as ye,r as O,t as be}from"./nip44-C1QNfhAC.js";import{A as xe,D as Se,E as Ce,F as we,I as Te,L as Ee,M as De,N as Oe,O as ke,P as k,T as Ae,_ as je,d as Me,f as Ne,g as Pe,h as Fe,j as Ie,k as Le,m as Re,p as ze,v as Be,y as Ve}from"./sync-Cb04crC8.js";import{t as A}from"./toast-BHUq2m9W.js";import{a as He,c as Ue,i as We,o as Ge,r as Ke}from"./profiles-acz-6pTl.js";var qe=Object.create,Je=Object.defineProperty,Ye=Object.getOwnPropertyDescriptor,Xe=Object.getOwnPropertyNames,Ze=Object.getPrototypeOf,Qe=Object.prototype.hasOwnProperty,$e=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),et=(e,t)=>{let n={};for(var r in e)Je(n,r,{get:e[r],enumerable:!0});return t||Je(n,Symbol.toStringTag,{value:`Module`}),n},tt=(e,t,n,r)=>{if(t&&typeof t==`object`||typeof t==`function`)for(var i=Xe(t),a=0,o=i.length,s;a<o;a++)s=i[a],!Qe.call(e,s)&&s!==n&&Je(e,s,{get:(e=>t[e]).bind(null,s),enumerable:!(r=Ye(t,s))||r.enumerable});return e},nt=(e,t,n)=>(n=e==null?{}:qe(Ze(e)),tt(t||!e||!e.__esModule?Je(n,`default`,{value:e,enumerable:!0}):n,e));(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function rt(e){let t=Math.floor(e/86400);if(t>=1)return`${t}d`;let n=Math.floor(e/3600);return n>=1?`${n}h`:`${Math.floor(e/60)}m`}function it(e){return e?`
    <div class="identity-badge">
      <span class="identity-badge__name">${w(e.displayName??`${e.pubkey.slice(0,8)}…`)}</span>
    </div>
  `:``}function at(e,t){let n=Object.values(e);if(n.length===0)return`<div class="group-list__empty">No groups yet</div>`;let{activePersonaName:r}=b();return n.map(e=>{let n=e.id===t,i=n?` group-list__item--active`:``,a=rt(e.livenessInterval),o=rt(e.livenessInterval),s=e.personaName?se(e.personaName):``,c=r&&e.personaName!==r?` hidden`:``;return`
        <button
          class="group-list__item${i}"
          data-group-id="${w(e.id)}"
          aria-current="${n?`true`:`false`}"
          ${c}
        >
          ${s}<span class="group-list__name">${w(e.name)}</span>
          <span class="group-list__preset">${w(a)} · ${w(o)}</span>
        </button>
